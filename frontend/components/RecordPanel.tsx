...
export function RecordPanel({ project }: { project: ProjectDetail }) {
  ...
  return (
    <div className="rounded-xl border bg-white p-5 shadow-sm">
      <h2 className="text-sm font-semibold text-slate-900">Record progress</h2>
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="border-t pt-3.5">
          <p className="text-xs font-semibold text-slate-700">Legal stage</p>
          <div className="mt-2 flex flex-wrap items-center gap-2">
            <span className="rounded bg-slate-900 px-2 py-1 font-mono text-xs font-semibold text-white">
            ...
            {nextStage ? (
              ...
              <span className="text-xs text-slate-500">Final stage reached</span>
            )}
          </div>
        </div>
        ...
        {/* Compensation */}
        <div className="border-t pt-3.5">
          <label className="text-xs font-semibold text-slate-700" htmlFor="comp-input">
          ...
          <div className="mt-2 flex items-center gap-2">
            <input
              ...
              className="w-24 rounded border border-slate-300 px-2 py-1.5 text-sm text-slate-900"
            />
        ...
        <div className="border-t pt-3.5">
          <p className="text-xs font-semibold text-slate-700">
            Litigation{" "}
            <span className="font-normal text-slate-500">({openCases.length} open)</span>
          </p>
          <div className="mt-2 flex flex-wrap items-center gap-2">
            <select
              value={caseType}
